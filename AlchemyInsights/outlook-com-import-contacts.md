...
---
# <a name="import-contacts"></a>Importul persoanelor de contact

Înainte să importați persoane de contact în Outlook.com, va trebui să le exportați de la alt furnizor de e-mail ca fișier. CSV. Apoi, urmați instrucțiunile de mai jos.
...
.
2. În partea de sus a paginii, selectați **gestionare** \> **persoane de contact import**.
3. Selectați **Răsfoire**, navigați la folderul în care ați salvat persoanele de contact exportate și selectați **Deschidere**.

Pentru a afla mai multe, consultați [importul persoanelor de contact în Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).