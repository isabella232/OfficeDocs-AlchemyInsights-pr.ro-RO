...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="d60db-102">Accesați pagina domenii</span><span class="sxs-lookup"><span data-stu-id="d60db-102">Access the Domains Page</span></span>

<span data-ttu-id="d60db-103">Pentru a accesa pagina de domenii, doar faceți clic pe această pictogramă de mai jos:</span><span class="sxs-lookup"><span data-stu-id="d60db-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="d60db-104">Apoi, puteți adăuga, modifica sau elimina domeniul.</span><span class="sxs-lookup"><span data-stu-id="d60db-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="d60db-105">Pentru mai multe informații, consultați [întrebări frecvente despre domenii.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="d60db-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
