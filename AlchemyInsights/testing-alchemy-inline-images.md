---
title: Testarea Alchemy în linie imagini
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="0e70a-102">Accesarea paginii domenii</span><span class="sxs-lookup"><span data-stu-id="0e70a-102">Access the Domains Page</span></span>

<span data-ttu-id="0e70a-103">Pentru a accesa pagina domenii, trebuie doar să faceți clic pe această pictogramă de mai jos:</span><span class="sxs-lookup"><span data-stu-id="0e70a-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="0e70a-104">Apoi puteți să adăugați, să modificați sau să eliminați domeniul.</span><span class="sxs-lookup"><span data-stu-id="0e70a-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="0e70a-105">Pentru mai multe informații, consultați [întrebări frecvente despre domenii.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="0e70a-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
