...
- Urmaţi paşii din t[Cum pentru a actualiza sau a repara setările de un domeniu federativ în Office 365, Azure, sau Intune](https://support.microsoft.com/en-us/help/2647048/how-to-update-or-repair-the-settings-of-a-federated-domain-in-office-3).
    
Pentru informaţii suplimentare despre reînnoirea certificatelor de Federaţia, a se vedea [certificatul de reînnoire pentru O365 şi Azur AD](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-o365-certs).
