...
ms.locfileid: "43529688"
---
# <a name="sharing-links-are-grayed-out"></a><span data-ttu-id="93c55-102">Linkurile de partajare sunt estompate</span><span class="sxs-lookup"><span data-stu-id="93c55-102">Sharing links are grayed out</span></span>

<span data-ttu-id="93c55-103">Dacă anumite opțiuni de partajare sunt estompate atunci când încercați să partajați din SharePoint Online sau OneDrive, consultați [Opțiunile de partajare sunt estompate atunci când partajați din SharePoint Online sau OneDrive](https://docs.microsoft.com/sharepoint/support/administration/sharing-options-grayed-out-when-sharing-from-sharepoint-online-or-onedrive).</span><span class="sxs-lookup"><span data-stu-id="93c55-103">If particular sharing options are grayed out when attempting to share from SharePoint Online or OneDrive, please review [Sharing options are grayed out when sharing from SharePoint Online or OneDrive](https://docs.microsoft.com/sharepoint/support/administration/sharing-options-grayed-out-when-sharing-from-sharepoint-online-or-onedrive).</span></span>
