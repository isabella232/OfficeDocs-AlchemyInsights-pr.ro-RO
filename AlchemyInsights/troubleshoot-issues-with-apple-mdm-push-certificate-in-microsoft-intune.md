...
ms.locfileid: "29485494"
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Depanarea problemelor cu Apple MDM împinge certificat în Microsoft Intune

Consultaţi resurse enumerate mai jos pentru a rezolva problema acum. 
  
1. Revizui [acest document](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) pentru a configura sau să reînnoiască certificatul de împingere Apple MDM. 
