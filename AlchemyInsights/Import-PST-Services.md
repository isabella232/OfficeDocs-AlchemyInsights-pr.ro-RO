...
4. Pentru a finaliza pașii din expert, urmați aceste [instrucțiuni pas cu pas](https://docs.microsoft.com/microsoft-365/security/office-365-security/use-dkim-to-validate-outbound-email).

**Important**: Pentru a accesa pagina **Import** din Centrul de securitate & conformitate, vi s-au atribuit [permisiunile corespunzătoare](https://docs.microsoft.com/microsoft-365/security/office-365-security/use-dkim-to-validate-outbound-email).
