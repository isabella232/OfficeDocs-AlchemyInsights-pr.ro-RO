...
- Consultați [Sistemul de telefonie și planurile de apelare](https://docs.microsoft.com/MicrosoftTeams/calling-plan-landing-page) pentru mai multe detalii. 
- Consultați [Prețurile pentru sistemul de telefonie](https://www.microsoft.com/microsoft-365/microsoft-teams/voice-calling#Requirements) pentru a vedea planurile și prețurile.
- Adăugați [Credite de comunicare](https://docs.microsoft.com/MicrosoftTeams/country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans#communications-credits) pentru utilizatorii care trebuie să facă dial-out către orice destinație.

Pentru mai multe informații, consultați [Disponibilitatea țărilor și regiunilor pentru conferințele audio și planurile de apelare](https://docs.microsoft.com/MicrosoftTeams/country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans). 
