...
---
# <a name="turn-off-text-predictions"></a>Dezactivarea predicțiilor text

1. Selectați **setări > Vizualizați toate setările Outlook > corespondență > Compuneți și răspundeți**.
2. Sub **predicții text**, deselectați **sugerați cuvinte de expresii pe măsură ce tastez**.
