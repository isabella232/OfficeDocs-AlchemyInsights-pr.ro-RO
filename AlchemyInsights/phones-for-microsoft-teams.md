...
ms.locfileid: "47701835"
---
# <a name="are-you-looking-for-phones-that-are-compatible-with-teams"></a>Căutați telefoane compatibile cu teams?

Ca administrator, [Gestionați toate dispozitivele](https://docs.microsoft.com/microsoftteams/device-management) utilizate cu teams din organizația dvs., din centrul de administrare Microsoft 365. Pentru mai multe informații: 

- Revizuiți lista de [telefoane pentru Microsoft teams](https://docs.microsoft.com/microsoftteams/phones-for-teams). 
- Revizuiți lista de [telefoane IP certificate în prezent](https://docs.microsoft.com/microsoftteams/teams-ip-phones#currently-certified-ip-phones). 
